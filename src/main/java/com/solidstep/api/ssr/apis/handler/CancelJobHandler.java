...
import com.solidstep.api.ssr.parameters.response.CancelJobResponse;

public class CancelJobHandler extends SSRApiHandler{

	@Override
	public SSRApiResult<CancelJobResponse> handle(Object ssrRequest) {
