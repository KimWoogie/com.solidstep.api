...
import com.solidstep.api.ssr.parameters.request.GetAdtTemplateInfoRequest;
import com.solidstep.api.ssr.parameters.response.GetAdtTemplateInfoResponse;
import com.solidstep.api.ssr.utils.SSRApiUtils;

public class GetAdtTemplateInfoHandler extends SSRApiHandler {

	@Override
	public SSRApiResult<GetAdtTemplateInfoResponse> handle(Object ssrRequest) {
		GetAdtTemplateInfoRequest getAdtTemplateInfoRequest = (GetAdtTemplateInfoRequest)ssrRequest;
		String apiResultString = this.ssrApiCall(getAdtTemplateInfoRequest);
		JSONObject resultInfoGenerate = SSRApiUtils.resultInfoGenerate(apiResultString);
		String apiJsonResultKey = getAdtTemplateInfoRequest.getApiJsonResultKey();
		List<Object> resultList = SSRApiUtils.listResultObjectMapping(GetAdtTemplateInfoResponse.class, apiResultString, apiJsonResultKey);
		SSRApiResult<GetAdtTemplateInfoResponse> result = new SSRApiResult<GetAdtTemplateInfoResponse>(resultList);
		try {
